...
@AnalyzeClasses(packagesOf = TransactionAggregationApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(TransactionAggregationApp.class), alwaysTrue())
